function scoreFun(object, opts) {
    var defaults = {
        fen_d: 16,
        ScoreGrade: 10,
        types: ["很不满意", "很不满意", "不满意", "不满意", "一般", "一般", "一般", "满意", "满意", "非常满意"],
        nameScore: "fenshu",
        paramScore: "score",
        parent: "star_score",
        attitude: "attitude"
    ...
    var paramScore = object.find("." + options.paramScore);
    ...
    startParent.find("a").each(function(index, element) {
        $(this).click(function() {
            now_cli = index;
            show(index, $(this), true)
        });
        $(this).mouseenter(function() {
            show(index, $(this), false)
        });
